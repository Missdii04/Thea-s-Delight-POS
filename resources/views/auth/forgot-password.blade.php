...
<head>
    ...
    <title>Thea's Delight - Forgot Password</title>
...
<body>
    ...
    <div class="content-panel bg-white p-8 lg:p-12">
        ...
        @if ($errors->has('email'))
        <div class="bg-red-100 border border-red-400 text-red-700 p-4 rounded-lg mb-4 text-center font-semibold">
            {{ $errors->first('email') }}
        </div>
    @endif
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <p>&nbsp;</p>
        <div >
            <x-primary-button style="text-align: center; height: 50px;" class="w-full flex items-center justify-center bg-custom-light-register text-custom-magenta font-bold rounded-md shadow-md transition duration-150 ease-in-out hover:bg-custom-pink-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-300">
